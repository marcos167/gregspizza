...
export default function Login() {
    ...
    const handleSubmit = async (e: React.FormEvent) => {
        ...
        try {
            ...
            // Force full page redirect to ensure everything reloads
            window.location.href = '/dashboard';
        } catch (err: any) {
            console.error('❌ Erro no login:', err);
            const errorMessage = err.message || err.error_description || 'Erro ao fazer login. Verifique suas credenciais.';
